...
Namespace WindowsApplication2.nwindDataSet1TableAdapters
	...
	Partial Public Class OrdersTableAdapter
		...
		Public Overridable Function Fill(ByVal dataTable As nwindDataSet1.OrdersDataTable) As Integer
		...
		Public Overridable Function GetData() As nwindDataSet1.OrdersDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As New nwindDataSet1.OrdersDataTable()
		...
		Public Overridable Function Update(ByVal dataTable As nwindDataSet1.OrdersDataTable) As Integer
